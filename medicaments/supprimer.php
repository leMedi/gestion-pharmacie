...
if(isset($_POST['confirmer']) && isset($_POST['id']))
{
	...
	$medicament = $medicament->trouver('id', $_POST['id']);
	if($medicament != false)
	{
                ...
                <div class="col-lg-push-3 col-lg-6">
                    <div class="card"  style="text-align: center;">
                        <div class="header">
                            ...
                            <h5>Voulez-vous vraiment supprimer cet medicament?</h5>
                        </div>
                        <div class="content">
                            <form class="form-inline" method="POST" >
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?= lien('/medicaments/') ?>" type="submit" class="btn btn-danger">Annuler</a>
                                </div> <!-- .form-group -->
