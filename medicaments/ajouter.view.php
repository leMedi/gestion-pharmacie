                                ...
                                <form method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="medicament[prix_achat]" type="number" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Le prix de vente</label>
                                                <input name="medicament[prix_vente]" type="number" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Aille</label>
                                                <input name="medicament[aille]" type="text" class="form-control" placeholder="A">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="medicament[expiration]" type="date" class="form-control">
                                            </div>
                                        </div>
                                    </div>
